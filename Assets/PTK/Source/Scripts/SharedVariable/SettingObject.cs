...
namespace PTK
{
    ...
    /// </summary>
    /// <remarks>use multiple save methods to sync setting data between multiple locations. list order to prioritize save location when loading.</remarks>
    [CreateAssetMenu(menuName = "PTK/Setting Object")]
    public class SettingObject : ScriptableObject
    {
        /// <summary>
        /// Whether or not a setting data exists
        /// </summary>
        public bool HasSave
        {
            get
