...
namespace PTK
{
    ...
    public class SettingObjectEditor : Editor
    {
        ...
        internal const int select_width = 100;
        ...
        public SettingObject settingObject
        {
            get
            {
                return (SettingObject)target;
            }
        }

        private void OnEnable()
        {
            if(settingObject.SaveLocations == null)
                settingObject.SaveLocations = new List<SaveMethod>();
            if(settingObject.Data == null)
                settingObject.Data = new List<SavableVariable>();
            saveLocationList = new ReorderableList(settingObject.SaveLocations, typeof(List<SaveMethod>), true, true, true, true);
            saveLocationList.drawHeaderCallback = OnDrawHeaderLocation;
            saveLocationList.drawElementCallback = OnDrawElementLocation; ;
            saveLocationList.elementHeightCallback = GetElementHeightLocation; ;
            saveLocationList.onReorderCallback = ListUpdated; ;
            saveLocationList.onAddCallback = OnAddElementLocation;

            variablesList = new ReorderableList(settingObject.Data, typeof(List<SavableVariable>), true, true, true, true);
            ...
            variablesList.onReorderCallback = ListUpdated;
            variablesList.onAddCallback = OnAddElementVariables;
        }

        #region Save Locations List
        ...
        {
            settingObject.SaveLocations.Add(null);
        }
        ...
        {
            return SaveSystemUtils.Base64ToTexture(icon);
        }
        #endregion
    }
}